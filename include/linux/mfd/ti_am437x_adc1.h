...
#define STEPCONFIG_GAIN1(val)	((val) << 5)
#define STEPCONFIG_GAIN2(val)	((val) << 7)
#define STEPCONFIG_GAIN3(val)	((val) << 9)
#define STEPCONFIG_GAIN4(val)	((val) << 28)
...
#define CNTRLREG_SIMULTANEOUS_CTRL      BIT(2)
